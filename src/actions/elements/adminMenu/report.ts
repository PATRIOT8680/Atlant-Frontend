import { IMsg } from "../../../views/AdminMenu/pages/Reports";

export const setReport = (id: number, listMsg: IMsg[], status: 'waiting' | 'reviewed', responder: string | null) => {
  return { 
    type: 'SET_REPORT',
...
export const updateReportStatus = (id: number, status: 'waiting' | 'reviewed', responder: string | null) => ({
