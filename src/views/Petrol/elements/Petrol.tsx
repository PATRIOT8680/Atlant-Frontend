...
const Petrol: FC<IPetrol> = ({ selectedVeh, vehFuel, maxFuel, typePetrolVeh, petrolIsVisible }) => {
  ...
  maxPetrolAmount = parseFloat(maxPetrolAmount.toFixed(2))
  ...
  const totalPrice = Math.floor(getSelectedPrice() * selectedAmount)
  ...
  const handleSubmitPay = () => {
    mp.trigger('client.close.petrol', selectedType, selectedAmount, selectedPay, totalPrice)
  }


  return(
    <>
      <div className= {petrolIsVisible ? "petrol" : "petrol hidden"} id={selectedPetrolShortName}>
        <div className="blobs">
